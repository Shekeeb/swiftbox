        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="w-full px-6 py-6 space-y-4">
                ...
                <div className="bg-white rounded-xl border border-gray-100 p-6">
                    ...
                    <div className="grid grid-cols-4 gap-4 pt-4 border-t border-gray-100">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-gray-900">
                                {new Date(orderData.scheduledAt).toLocaleDateString("en-IN", {
                                    day: "numeric",
                                    month: "short",
                                })}
                            </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <TrackingClient orderId={orderData._id.toString()} status={orderData.status} userId={user.id} userRole={user.role} pickupCoords={pickupCoords} dropoffCoords={dropoffCoords} />
                    </div>
                </div>
            </div>
        </div>
